...
proc init_gui { IPINST } {
  ...
  set BIT_SMP_PRE_TDL [ipgui::add_param $IPINST -name "BIT_SMP_PRE_TDL" -parent ${Page_0}]
  set_property tooltip {Number of taps sampled on the PRE-TDL} ${BIT_SMP_PRE_TDL}
  set BIT_SMP_TDL [ipgui::add_param $IPINST -name "BIT_SMP_TDL" -parent ${Page_0}]
  ...
  set MAX_VALID_TAP_POS [ipgui::add_param $IPINST -name "MAX_VALID_TAP_POS" -parent ${Page_0}]
  ...
  set MIN_VALID_TAP_POS [ipgui::add_param $IPINST -name "MIN_VALID_TAP_POS" -parent ${Page_0}]
  ...
  set STEP_VALID_TAP_POS [ipgui::add_param $IPINST -name "STEP_VALID_TAP_POS" -parent ${Page_0}]
  ...
  set TYPE_TDL_1 [ipgui::add_param $IPINST -name "TYPE_TDL_1" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 1} ${TYPE_TDL_1}
  set TYPE_TDL_10 [ipgui::add_param $IPINST -name "TYPE_TDL_10" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 10} ${TYPE_TDL_10}
  set TYPE_TDL_11 [ipgui::add_param $IPINST -name "TYPE_TDL_11" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 11} ${TYPE_TDL_11}
  set TYPE_TDL_12 [ipgui::add_param $IPINST -name "TYPE_TDL_12" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 12} ${TYPE_TDL_12}
  set TYPE_TDL_13 [ipgui::add_param $IPINST -name "TYPE_TDL_13" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 13} ${TYPE_TDL_13}
  set TYPE_TDL_14 [ipgui::add_param $IPINST -name "TYPE_TDL_14" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 14} ${TYPE_TDL_14}
  set TYPE_TDL_15 [ipgui::add_param $IPINST -name "TYPE_TDL_15" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 15} ${TYPE_TDL_15}
  set TYPE_TDL_2 [ipgui::add_param $IPINST -name "TYPE_TDL_2" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 2} ${TYPE_TDL_2}
  set TYPE_TDL_3 [ipgui::add_param $IPINST -name "TYPE_TDL_3" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 3} ${TYPE_TDL_3}
  set TYPE_TDL_4 [ipgui::add_param $IPINST -name "TYPE_TDL_4" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 4} ${TYPE_TDL_4}
  set TYPE_TDL_5 [ipgui::add_param $IPINST -name "TYPE_TDL_5" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 5} ${TYPE_TDL_5}
  set TYPE_TDL_6 [ipgui::add_param $IPINST -name "TYPE_TDL_6" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 6} ${TYPE_TDL_6}
  set TYPE_TDL_7 [ipgui::add_param $IPINST -name "TYPE_TDL_7" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 7} ${TYPE_TDL_7}
  set TYPE_TDL_8 [ipgui::add_param $IPINST -name "TYPE_TDL_8" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 8} ${TYPE_TDL_8}
  set TYPE_TDL_9 [ipgui::add_param $IPINST -name "TYPE_TDL_9" -parent ${Page_0} -widget comboBox]
  set_property tooltip {CO vs O Sampling TDL 9} ${TYPE_TDL_9}
  set VALID_NUMBER_OF_TDL_INIT [ipgui::add_param $IPINST -name "VALID_NUMBER_OF_TDL_INIT" -parent ${Page_0}]
  ...
  set VALID_POSITION_TAP_INIT [ipgui::add_param $IPINST -name "VALID_POSITION_TAP_INIT" -parent ${Page_0}]
