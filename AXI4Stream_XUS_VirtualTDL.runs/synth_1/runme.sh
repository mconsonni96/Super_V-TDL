...
HD_PWD='/home/mconsonni/Desktop/DESD/Projects/AXI4Stream_XUS_VirtualTDL/AXI4Stream_XUS_VirtualTDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4Stream_XUS_VirtualTDL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI4Stream_XUS_VirtualTDL.tcl
